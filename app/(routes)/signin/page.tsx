  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 items-start justify-center text-center w-full pl-28">
        ...
        <span className="text-xl opacity-[0.9] text-white text-left">Lorem ipsum dolor sit amet, consectetur.</span>
        <Link
    ...
    <div className='right-sect flex-1 w-full flex justify-center p-4 mx-5'>
      <Card className='border-none w-full max-w-md flex flex-col items-start justify-center'>
            <CardHeader>
            ...
            <CardContent className='w-full px-10'>
              {globalError && <ErrorMessage error={globalError}/>}
                    ...
                    <FormField 
                      ...
                      <FormItem>
                        ...
                        <Input
                            ...
                            icon={<Image className="pl-2" src="/assets/icons/email_ic.svg" width={25} height={25} alt="email-icon" />}
                            autoComplete="off"
                            {...field}
                          />
                        </FormControl>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input 
                            ...
                            icon={<Image className="pl-2" src="/assets/icons/pass_ic.svg" width={25} height={25} alt="email-icon" />}
                            {...field}
                            /> 
                        </FormControl>
                        <FormMessage/>
                ...
                <form className='w-full' action={handleGithubSignin}>
                  <Button variant="outline" type='submit' className="w-full bg-light-white rounded-full p-7">
